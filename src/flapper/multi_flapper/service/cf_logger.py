    ...
    def __init__(self, drone_id):
        ...
        self.log_list = [
            LogData(
                "estimate_position",
                Vector3,
                "log_estimate_position_pub",
                "log/state_estimate/position",
                [
            ...
            LogData(
                ...
                Quaternion,
                "log_estimate_orientation_pub",
                "log/state_estimate/orientation",
                [
            ...
            LogData(
                "estimate_acc",
                Vector3,
                "log_estimate_acc_pub",
                "log/state_estimate/acc",
                [
            ...
            LogData(
                "estimate_vel",
                Vector3,
                "log_estimate_vel_pub",
                "log/state_estimate/vel",
                [
        ...
        for log_data in self.log_list:
            log_data.topic_name = f"cf{self.drone_id}/" + log_data.topic_name
            setattr(
                self,
                log_data.attribute_name,
                rospy.Publisher(log_data.topic_name, log_data.pub_class),
            )
    ...
    def generate_log_configs(self):
        ...
        for idx, log_data in enumerate(self.log_list):
            ...
            log_config.data_received_cb.add_callback(
                self.generate_log_data_callback(log_data)
            )
