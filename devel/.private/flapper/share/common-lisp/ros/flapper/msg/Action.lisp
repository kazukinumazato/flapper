...
(cl:defmethod cl:initialize-instance :after ((m <Action>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Action)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name flapper-msg:<Action> is deprecated: use flapper-msg:Action instead.")))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <Action>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader flapper-msg:name-val is deprecated.  Use flapper-msg:name instead.")
  (name m))

(cl:ensure-generic-function 'height-val :lambda-list '(m))
(cl:defmethod height-val ((m <Action>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader flapper-msg:height-val is deprecated.  Use flapper-msg:height instead.")
  (height m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Action>)))
  ...
  "70ac77d41564567d694a44436c064b02")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Action)))
  "Returns md5sum for a message object of type 'Action"
  "70ac77d41564567d694a44436c064b02")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Action>)))
  ...
  (cl:format cl:nil "string name~%float64 height~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Action)))
  "Returns full string definition for message of type 'Action"
  (cl:format cl:nil "string name~%float64 height~%~%~%~%"))
