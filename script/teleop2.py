...
# 入力受付クラス
class Teleop():
    def __init__(self, motion_manager, motion_manager2=None):
        self.motion_manager = motion_manager
        self.motion_manager2 = motion_manager2
    ...
    def palm_land_sub_callback(self, msg):
        ...
        self.motion_manager2.palm_land(yaw)
    ...
    def approach_sub_callback(self, msg):
        ...
        self.motion_manager2.approach(msg.position.x, msg.position.y, msg.position.z, yaw)
